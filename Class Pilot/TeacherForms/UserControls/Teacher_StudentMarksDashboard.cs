...
{
    public partial class Teacher_StudentMarksDashboard : UserControl
    {

       
        public Teacher_StudentMarksDashboard()
        {
            InitializeComponent();
        ...
        private void Teacher_StudentMarksDashboard_Load(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void Btn_Click(object sender, EventArgs e)
        {
            ...
            if (clickedBtn != null)
            {
                ...
                teacher_StudentMarksTable1.Show();
            }
        }
