...
namespace Classpilot___Myclass01
{
    public partial class Teacher_MyClassDashboard : UserControl
    {

        public Teacher_MyClassDashboard()
        {
            InitializeComponent();
        }

        private void Teacher_MyClassDashboard_Load(object sender, EventArgs e)
        {
            this.Hide();
            btn1.Visible = false;
            btn2.Visible = false;
