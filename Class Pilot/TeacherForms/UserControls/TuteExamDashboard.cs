...
namespace Class_Pilot.TeacherForms.UserControls
{
    public partial class TuteExamDashboard : UserControl
    {
        public TuteExamDashboard()
        {
            InitializeComponent();
        }

        private void TuteExamDashboard_Load(object sender, EventArgs e)
        {
            btn1.Visible = false;
            btn2.Visible = false;
            btn3.Visible = false;
